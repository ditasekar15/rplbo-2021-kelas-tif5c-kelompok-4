            ...
            <div class="card-body table-responsive">
                        ...
                        foreach ($tampildata as $row) : ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-effect-ripple btn-success" data-toggle="modal" data-target="#modal_edit_suratmasuk<?= $row->id; ?>">
                                        <i class="fa fa-edit"></i>
                                    </button>

                                    <a onclick="javascript:return confirm('Apakah Anda Yakin Ingin Menghapus <?php echo $row->nosurat; ?> ?');" href="<?php echo base_url() . 'suratmasuk/' . $row->id; ?>" data-toggle="tooltip" title="Hapus <?php echo $row->nosurat; ?>" class="btn btn-effect-ripple btn-danger"><i class="fa fa-trash"></i>
                                    </a>
                                </td>
                            <?php endforeach; ?>
                ...
                <script>
                    function hapus(noku) {
                        ...
                        if (pesan) {
                            window.location.href = ("<?= site_url('Suratmasuk/hapus') ?>") + noku;
                        } else return false;
                    }
                </script>
            </div>
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('Suratmasuk/save'); ?>" method="post" enctype="multipart/form-data">
...
foreach ($tampildata as $row) : ?>
    ...
    <tr>
        <div class="modal fade" id="modal_edit_suratmasuk<?= $row->id; ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">

                        <h4 class="modal-title">Edit Data Surat Masuk (<?= $row->file; ?>)</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <form action="<?= base_url('/Suratmasuk/edit' . $row->id); ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">No Surat</label>
                            <div class="col-sm-9">
