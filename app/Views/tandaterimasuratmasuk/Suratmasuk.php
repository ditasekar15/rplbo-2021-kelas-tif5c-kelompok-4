...
<section class="content">
    ...
    <div class="section">
        <center>
            <h2>Data Tanda Terima Surat Masuk</h2>
        </center>
        ...
        <div class="card">
            ...
            <div class="card-header">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-default">
                    + Tambah Data Terima Surat Masuk
                </button>
            ...
            <div class="card-body table-responsive">
                <table id="example1" class="table table-striped table-bordered table-vcenter">
                    ...
                    <tbody>
                        <?php $no = 1;
                        foreach ($tandaterimamasuk as $row) : ?>
                            ...
                            <tr>
                                ...
                                <td> <?= $row->file; ?>
                                <td><a href="<?php echo base_url() . 'Tandaterimasuratmasuk/download/' . $row->id; ?>" class="btn btn-success btn-sm">download<span class="glyphicon glyphicon-download-alt"></a></td>
                            </tr>
